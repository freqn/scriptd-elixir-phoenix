defmodule Scriptd.AccountsTest do
  use Scriptd.DataCase
  ...
  describe "prescriptions" do
    alias Scriptd.Accounts.Prescription
  ...
  describe "orders" do
    ...
    @valid_attrs %{prescription_id: 42}
    @update_attrs %{prescription_id: 43}
    @invalid_attrs %{prescription_id: nil}
